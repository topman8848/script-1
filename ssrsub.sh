#!/bin/bash
# Usage:
#  bash <(curl -s https://raw.githubusercontent.com/mixool/script/master/ssrsub.sh)
#  wget --no-check-certificate https://raw.githubusercontent.com/mixool/script/master/ssrsub.sh && chmod +x ssrsub.sh && ./ssrsub.sh
